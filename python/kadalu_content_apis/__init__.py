...
class Connection(ConnectionBase):
    ...
    def upload_template(self, name, file_path, template_type, output_type="text", public=False):
        """ Upload Template """
        return Template.create_by_upload(self, name, file_path, template_type, output_type, public)
